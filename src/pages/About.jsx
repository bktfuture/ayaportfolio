	...
	return (
		<section className="max-container">
			...
			<div className="mt-5 flex  gap-3 text-slate-500">
				<p>
					Second Year Computer Science student at the University of Missouri-St.Louis. 6 Hackathon Winner including MIT XR Hackathon Qualcomm AR
					glasses recipient, BobaTalks x Grow With Google Winner, and more! - "Pillar of STLCC" Award Winner and twice elected President of TRIO
